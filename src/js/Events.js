 ...
 */
Events.subscribe = function subscribe(Object) {
    var customEvent;
 ...
 * @return {null}            Does not return anything.
 */
Events.unsubscribe = function unsubscribe(Object) {
    var customEvent,
        l;
 ...
 */
Events.publish = function publish(eventKey, parameters, view) {
    var functions,
        l,
        x;
 ...
 */
Events.add = function add(eventKeys) {
    var customEvent;
 ...
 */
Events.hasEvent = function hasEvent(key) {
